      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Text style={text}>
              Welcome to <strong>BetaLyfe</strong> — we’re so glad to have you
              with us!
            </Text>

            <Text style={text}>With BetaLyfe, you now have access to:</Text>

            <ul style={{ paddingLeft: 20 }}>
              <li style={text}>✔️ Video consultations with verified doctors</li>
              <li style={text}>
                ✔️ Order prescriptions from trusted pharmacies
              </li>
            ...
            <Text style={text}>
              <strong>The BetaLyfe Team</strong>
            </Text>

            <Text
              style={{ ...text, fontSize: 12, color: '#888', marginTop: 30 }}
            >
              This message was sent to {user.email}. If you did not sign up for
              BetaLyfe, you can safely ignore this email.
            </Text>
          </Section>
        </Container>
      </Body>
