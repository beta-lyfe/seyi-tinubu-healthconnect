...
export type Response =
  types.paths['/api/consultation/request/{id}/accept']['post']['responses'][keyof types.paths['/api/auth/sign-in']['post']['responses']]['content']['application/json']
...
export default new Hono().post(
  ...
  async (c) => {
    ...
    const { start_time, end_time, patient_id, doctor_id, message } =
      acceptedConsultationRequest.value
