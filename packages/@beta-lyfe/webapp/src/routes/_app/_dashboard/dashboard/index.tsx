...
import { Calendar, Clock, MessageSquare, ArrowRight, Search, Star, Activity } from "lucide-react"
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Here's an overview of your telehealth services.</p>
          </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle  className="text-xl pb-2 md:text-2xl">Upcoming Appointments</CardTitle>
            <CardDescription>Your next scheduled telehealth consultations</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mt-4">
                  ...
                  <div className="flex gap-2 mt-2 md:mt-0">
                    ...
                    <Button size="sm" className="text-white">Join Call</Button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mt-4">
                  <p className="text-sm">Asynchronous consultation for skin condition</p>
                  <div className="flex gap-2 mt-2 md:mt-0">
                    <Button variant="outline" size="sm">
                      View Details
                    </Button>
                    <Button size="sm" className="text-white">Message</Button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Your latest conversations with doctors</CardDescription>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <p className="font-medium text-sm truncate">Dr. Sarah Johnson</p>
                  <p className="text-xs text-muted-foreground">2h ago</p>
                </div>
                <p className="text-sm text-muted-foreground truncate">
                  Please let me know if you've been taking the medication as prescribed...
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground truncate">
                  I've reviewed the photos of your skin condition. It appears to be...
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground truncate">
                  Your lab results look good. Your blood pressure has improved since...
                </p>
              </div>
            </div>
          </CardContent>
