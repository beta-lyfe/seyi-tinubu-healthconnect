        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mt-4">
              <JoinButton token={consultation.token} roomname={consultation.room_name}
...
export function JoinButton({
  ...
  return (
   <div className="flex gap-2 mt-2 md:mt-0">
                <Button size="sm" className='text-white' onClick={()=>setIsOpen(true)}>Join Call</Button>
                <JoinCallModal isOpen={isOpen} onClose={()=>setIsOpen(false)} token={token} roomname={roomname}
