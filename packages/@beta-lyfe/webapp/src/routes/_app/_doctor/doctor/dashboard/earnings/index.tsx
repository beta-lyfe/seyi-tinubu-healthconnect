  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Earnings & Transactions</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="md:col-span-2">
          <CardHeader className="pb-3">
            ...
            <CardDescription>Your earnings summary for the selected period</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm text-muted-foreground">May 1 - May 31, 2023</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 border rounded-md dark:border-gray-800">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Chat Consultations</p>
              ...
              <div className="flex items-center gap-3 p-3 border rounded-md dark:border-gray-800">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Prescription Fees</p>
            ...
            <TabsContent value="all" className="space-y-4">
              <div className="flex items-center gap-3 p-3 border rounded-md dark:border-gray-800">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      <p className="font-medium">Video Consultation with John Doe</p>
                      <p className="text-sm text-muted-foreground">Follow-up for heart condition</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="flex items-center gap-1">
                        <Calendar className="h-3 w-3" /> May 15, 2023
                      </Badge>
                      <p className="font-semibold text-green-600 dark:text-green-400">+₦150.00</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 border rounded-md dark:border-gray-800">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      <p className="font-medium">Chat Consultation with Maria Garcia</p>
                      <p className="text-sm text-muted-foreground">Initial consultation for chest pain</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="flex items-center gap-1">
                        <Calendar className="h-3 w-3" /> May 14, 2023
                      </Badge>
                      <p className="font-semibold text-green-600 dark:text-green-400">+₦75.00</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Lisinopril for John Doe</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="flex items-center gap-1">
                        <Calendar className="h-3 w-3" /> May 12, 2023
                      </Badge>
                      <p className="font-semibold text-green-600 dark:text-green-400">+₦25.00</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Direct deposit to account ending in 4242</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="flex items-center gap-1">
                        <Calendar className="h-3 w-3" /> May 1, 2023
                      </Badge>
                      <p className="font-semibold text-amber-600 dark:text-amber-400">-₦10,850.00</p>
                    </div>
                  </div>
                </div>
              </div>
