...
import { Video, Heart, Users, Globe, Award, Shield, Lightbulb, Zap, Building, MapPin } from "lucide-react"
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    BetaLyfe is on a mission to make quality healthcare accessible to all Nigerians through innovative
                    technology and a network of dedicated healthcare professionals.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Bridging the Healthcare Gap</h2>
                <p className="text-muted-foreground md:text-xl/relaxed">
                  Our mission is to bridge the healthcare gap in Nigeria by leveraging technology to connect patients
                  with quality healthcare providers, regardless of location or socioeconomic status.
                </p>
                <p className="text-muted-foreground">
                  We're committed to making healthcare more accessible, affordable, and efficient for all Nigerians.
                  Through our platform, we aim to reduce the barriers to healthcare access, improve health outcomes, and
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Healthcare for Every Nigerian</h2>
                <p className="text-muted-foreground md:text-xl/relaxed">
                  We envision a Nigeria where every citizen has access to quality healthcare services, regardless of
                  their location or economic status.
                </p>
                <p className="text-muted-foreground">
                  By 2030, we aim to be the leading telehealth provider in Africa, serving millions of patients across
                  the continent with innovative healthcare solutions that address the unique challenges of African
                  healthcare systems.
                </p>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">The BetaLyfe Journey</h2>
            ...
            <div className="grid gap-8 md:grid-cols-4">
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    BetaLyfe was founded by Dr. Adebayo Johnson and Ngozi Okafor in Lagos with a vision to revolutionize
              ...
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We launched our telehealth platform with 50 doctors, focusing initially on general consultations and
              ...
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    BetaLyfe expanded to all 36 states in Nigeria, growing our network to over 1,000 healthcare
              ...
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold">Leading Telehealth Provider</h3>
                  <p className="text-muted-foreground">
                    Now with 2,500+ healthcare providers, 36+ specialties, and over 100,000 patients served, BetaLyfe is
                    Nigeria's premier telehealth platform.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Meet Our Leadership</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Core Principles That Guide Us</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We put patients at the center of everything we do, designing our services around their needs,
              ...
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We maintain the highest standards of medical care and data security, ensuring safe and effective
                    healthcare delivery.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We're committed to making quality healthcare accessible to all Nigerians, regardless of location,
              ...
              <Card className="bg-background">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We continuously innovate to improve healthcare delivery, leveraging technology to solve Nigeria's
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Card className="bg-background">
                    <CardContent className="p-6 flex flex-col items-center text-center space-y-2">
                      <span className="text-4xl font-bold text-primary">36+</span>
                  ...
                  <Card className="bg-background">
                    <CardContent className="p-6 flex flex-col items-center text-center space-y-2">
                      ...
                      <p className="text-muted-foreground">States Covered (All Nigeria)</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card className="bg-background">
                  <CardContent className="p-6 space-y-4">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <Award className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                        <span>Featured in Forbes Africa 30 Under 30 (Co-founders)</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        Through our mobile clinics and telehealth services, we've provided healthcare access to over
                        50,000 patients in rural communities across Nigeria who previously had limited or no access to
                        quality healthcare.
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        Our maternal health program has supported over 10,000 expectant mothers with prenatal care,
                        reducing complications and improving outcomes for both mothers and babies in underserved
                        communities.
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        Our chronic disease management program has helped over 15,000 patients with conditions like
                        diabetes and hypertension better manage their health, reducing hospital admissions by 40%.
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        Through our health education initiatives, we've reached over 200,000 Nigerians with vital
                        information about preventive care, disease management, and healthy living practices.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Strategic Partnerships</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Where to Find Us</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Card className="bg-background">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">Phone: +234 800 000 0000</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-background">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">45 Ademola Adetokunbo Crescent, Wuse II, Abuja, Nigeria</p>
                  <p className="text-muted-foreground">Phone: +234 800 000 0001</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-background">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    78 Aba Road, GRA Phase 2, Port Harcourt, Rivers State, Nigeria
                  </p>
                  <p className="text-muted-foreground">Phone: +234 800 000 0002</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Join Us in Transforming Healthcare</h2>
                <p className="max-w-[600px] md:text-xl">
                  Whether you're a patient seeking care, a healthcare provider looking to join our network, or a partner
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="instagram.com" className="text-sm text-muted-foreground hover:text-foreground">
