...
const navigation = [
  { name: 'Dashboard', href: '/doctor/', icon: LayoutDashboard, current: true },
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-white text-primary hover:text-primary' : 'text-indigo-100 hover:bg-white hover:text-primary',
              ...
              <nav className="flex-1 px-2 pb-4 space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-primary text-white' : 'text-indigo-100',
