...
import {BarChart,CartesianGrid,YAxis, Tooltip, Legend, Bar, PieChart, Pie, ResponsiveContainer } from 'recharts'
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div className="py-4">
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
                    {
                      dashBoardCardData.map(item=><DashboardCard item={item}/>)
                    }
                  </div>
                </div>
                ...
                <div className='flex flex-col gap-6 p-4 md:col-span-5'>
                  <h2 className='border-b-2 border-gray-300 pb-2 font-semibold'>Today's Appointment</h2>
...
const DashboardCard: FunctionComponent<{item:DashBoardCardData}> = ({item}) => {
  return(
    <div className={cn('rounded-md px-4 py-6 md:py-10 flex flex-col md:flex-row md:items-center gap-4', item.bgColor)}>
...
const DashboardPieChart:FunctionComponent=()=>{
  ...
  <PieChart width={730} height={250} className='w-full'>
    <Pie data={data01} dataKey="value" nameKey="name" cx="50%" cy="50%" radius={100} className='fill-primary' label/>
