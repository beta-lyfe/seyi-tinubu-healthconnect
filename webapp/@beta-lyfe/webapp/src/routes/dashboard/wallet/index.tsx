    ...
    return(
       ...
       <div className="p-5 bg-primary gap-5">
        ...
        <div className="p-6 md:p-8">
            <Typography.PageHeading className="pb-5">My Wallet</Typography.PageHeading>
            <WalletCard />
            <Transaction />
        </div>
        <BottomNav />
    ...
    return(
        <div className='bg-primary p-8 rounded-md flex flex-col gap-4'>
            <div className="flex gap-3">
                <Wallet2 color="white"/>
                <Typography.Info className="text-white">Avaliable Balance</Typography.Info>
            </div>
            <Typography.PageHeading className="text-white">NGN 3000</Typography.PageHeading>
            <div>
            <Button className="bg-white text-primary hover:bg-white hover:text-primary">Fund my wallet</Button>
            </div>
        </div>
    )
}
...
function TransactionSection(){
    ...
    const TransactionCard=({credit}:{credit?:boolean})=>(
        <>
         <div className="flex justify-between py-4">
            ...
            <div className={`p-2 rounded-lg ${credit ? 'bg-green-100' : 'bg-red-100' }`}>
                {credit ? 
            ...
            <div>
                <Typography.CardHeading>{credit ? "+":"-"}10000</Typography.CardHeading>
    ...
    return(
        <div className="py-4">
            <Typography.CardHeading className='opacity-65'>Today</Typography.CardHeading>
