...
import IykeForm, {
  IykeFormField,
  type IykeFormType
} from '@beta-lyfe/webapp/components/IykeForm'
import {
...
const PersonalInfoData: IykeFormType[] = [
  ...
  { name: 'Address', value: 'No 3 obinna street', inputType: 'text' },
  {
    ...
    value: '',
    inputType: 'text',
    placeholder: 'Tell us more about urself'
  }
]
...
const MedicalHistorydata: IykeFormType[] = [
  {
    value:
      'Fever Date - 2/3/2015 Treated by Dr. Emeka Chika at Salvation Hospital Owerri ',
    inputType: 'text'
  },
  {
    value:
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-4 flex-col p-4">
        ...
        <div className="flex items-center justify-center flex-row gap-4">
          ...
          <Button size="sm" className="bg-gray-400 flex gap-2">
      ...
      <div className="flex p-2 align-center flex-row max-md:flex-col">
        ...
        <section className="flex-grow">
          {!isDoctor ? (
            <>
              {index == 0 && <IykeForm data={PersonalInfoData} />}
...
function ProfileRoutes({
  ...
  mainIndex,
  route
}: { setIndex: Function; mainIndex: number; route: string[] }) {
  return (
  ...
  function ProfileRoute({
    ...
    return (
      ...
      >
        <li
          className={
            active ? 'border-l-4 pl-2 border-primary' : 'border-l-4 pl-2'
          }
        >
          {item}
        </li>
